...
export default function HomePage() {
  ...
  const tourSteps = [
    {
      targetId: "create-new-hug",
      title: "Create a Soul Hug",
      content: "Start your creative journey here to craft a personalized message.",
      direction: "right" as const,
      placement: "left" as const
    },
    {
      targetId: "view-my-hugs",
      title: "View Your Hugs",
      content: "Access all your saved Soul Hugs in one place.",
      direction: "right" as const,
      placement: "left" as const
    },
    {
      ...
      content: "Explore voice recording, AI narration, and music mixing.",
      direction: "right" as const,
      placement: "left" as const
    }
  ];
    ...
    <div className="min-h-screen flex flex-col items-center justify-center text-white p-6 bg-gradient-to-br from-purple-600 to-blue-800">
      <div className="text-center mb-12">
        ...
        <button 
          ...
          className="mt-4 px-4 py-2 bg-white/20 rounded-lg text-sm hover:bg-white/30 transition-all"
        >
          Show Guide
        </button>
      </div>
      ...
      <div className="space-y-4 w-full max-w-sm">
        <Link 
          href="/creative-flow"
          id="create-new-hug"
          className="block bg-white/10 backdrop-blur-sm rounded-lg px-6 py-4 text-center hover:bg-white/20 transition-all duration-200 border border-white/20 hover:border-white/40 relative"
        >
